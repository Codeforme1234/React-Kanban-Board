    ...
    <div className="bg-white rounded-lg shadow-md p-4 flex flex-col m-5 items-start max-w-[18em] w-full">
      ...
      <div className="flex ">
        <div className="w-5 mt-1.5 absolute h-3 rounded-full ">
          <CategoryIcon type="status" value={iconValue} className=""  />
        </div>
        <h4 className="text-gray-900 pt-2  pl-2 font-semibold text-[1em] pb-2 left-4 relative">
          {ticket.title}
        </h4>
      </div>
      <div className="flex items-center justify-between w-full">
        <div className="flex items-center">
          <div className="flex gap-2">
            ...
            <span className="text-gray-500 border-[1.5px] pt-1 pl-1 flex gap-2 px-2 text-sm">
